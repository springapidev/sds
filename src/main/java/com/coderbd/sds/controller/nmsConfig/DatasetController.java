...
import com.coderbd.sds.repo.DatasetRepo;
...
public class DatasetController {
    ...
    public ModelAndView getView() {
        ...
        modelAndView.addObject("obj", new Dataset());
        modelAndView.setViewName("dataset/create");
        return modelAndView;
    }

    @RequestMapping(value = "create.do", method = RequestMethod.POST)
    public ModelAndView saveOrUpdate(@Valid Dataset obj, BindingResult bindingResult) {
        ModelAndView modelAndView=new ModelAndView();
    ...
    public String updateRole(@PathVariable Integer id, Model model) {
        Optional<Dataset> obj1 = repo.findById(id);
    ...
    public ModelAndView getList() {
        ...
        modelAndView.setViewName("dataset/list");
        return modelAndView;
    }
}
