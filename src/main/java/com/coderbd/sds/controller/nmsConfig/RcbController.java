...
import com.coderbd.sds.repo.RcbRepo;
...
public class RcbController {
    @Autowired
    private RcbRepo repo;

    @RequestMapping(value = "create.do", method = RequestMethod.GET)
    public ModelAndView getView() {
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.addObject("obj", new Rcb());
        modelAndView.setViewName("rcb/create");
        return modelAndView;
    }
    ...
    public ModelAndView saveOrUpdate(@Valid Rcb obj, BindingResult bindingResult) {
        ModelAndView modelAndView=new ModelAndView();
    ...
    public String updateRole(@PathVariable Integer id, Model model) {
        Optional<Rcb> obj1 = repo.findById(id);
    ...
    public ModelAndView getList() {
        ...
        modelAndView.setViewName("rcb/list");
        return modelAndView;
    }
}
