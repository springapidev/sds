...
@Controller
@RequestMapping("/grevent/")
public class GooseEventController {
    @Autowired
    ...
    public ModelAndView getView() {
        ...
        modelAndView.setViewName("gooseevent/create");
        return modelAndView;
    }
    ...
    public String delRole(@PathVariable Integer id) {
        ...
        return "redirect:/grevent/create";
    }
    ...
    public ModelAndView getList() {
        ...
        modelAndView.setViewName("gooseevent/list");
        return modelAndView;
    }
}
